      ...
      songs: [
        {
          ...
          url: "https://ytd-lemon.vercel.app/api/ytdl/download?v=jzaBXuWnWdY&type=audio",
          cover_art_url:
...
<div
  class="min-h-screen bg-gray-100 flex flex-col items-center my-10"
  id="player"
>
  <div class="max-w-xl bg-white rounded-lg shadow-lg overflow-hidden">
    ...
    <progress
      id="amplitude-song-played-progress"
      class="absolute h-1 bg-gray-200"
    />

    <div id="amplitude-song-slider"><div id="amplitude-track-progress" /></div>
    <div
    ...
    >
      ...
      <div class="flex space-x-3 p-2">
        ...
        <button
          class="amplitude-play-pause rounded-full w-8 h-8 flex items-center justify-center pl-0.5 ring-2 ring-gray-100 focus:outline-none"
          id="amplitude-play-pause"
          on:click={() => {
            Amplitude.play({
          name: "Risin' High (feat Raashan Ahmad)",
          artist: "Ancient Astronauts",
